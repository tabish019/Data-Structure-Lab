//Write a menu-driven program that implements a circular linked list for the following operations: Create two lists (list1 to list2 and list2 to list1) and Concatenate two lists
...
NODE createNode(int data){
	...
	if(!newNode){
		printf("Moemory allocation failed!\n");
	}
	newNode->data = data;
